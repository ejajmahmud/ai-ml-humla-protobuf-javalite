...
public class HumlaException extends Exception implements Parcelable {
    ...
    private HumlaException(Parcel in) {
        ...
        try {
            mUserRemove = Mumble.UserRemove.parseFrom(in.createByteArray());
            mReject = Mumble.Reject.parseFrom(in.createByteArray());
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeSerializable(mReject.toByteArray());
        dest.writeSerializable(mUserRemove.toByteArray());
    }
